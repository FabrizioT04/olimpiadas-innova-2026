...
const PARTIDOS_OFICIALES: Partido[] = [
  // --- SEMANA 1 (14/09 al 18/09) ---
  {
    ...
    semana: 1,
    fecha: '2026-09-14',
    dia: 'Lunes 14/09/2026',
    hora: '09:35 - 09:55 am',
    deporte: 'CONEBALL / BÁSQUET',
    enfrentamiento: 'BLANCO VS VERDE',
    categoria: 'Infantil (3º y 4º)',
    arbitro: 'DAVID',
    apoyo: 'Melissa Gurrionero, Gloria Huaman, Nicol Aguilar, Dayanara Quirica',
    lugar: 'Campo 1',
    estado: 'finalizado'
  },
  {
    ...
    arbitro: 'DAVID',
    apoyo: 'Dayanara Quirica, Jorge Romero, Karla Armas',
    lugar: 'Campo 1',
    estado: 'finalizado'
  },
  {
    ...
    deporte: 'BÁSQUET',
    enfrentamiento: 'BLANCO VS VERDE',
    categoria: 'Juvenil A (7º y 8º)',
    arbitro: 'ENRIQUE ALCAZAR',
    apoyo: 'Jimena Esteban, David Sajami, Karol Caballero, Diana Liviapoma',
    lugar: 'Campo 1',
    estado: 'finalizado'
  },
  {
    ...
    arbitro: 'MARIO NUÑEZ / DAVID',
    apoyo: 'Tutores y Cotutores, Volates',
    lugar: 'Campo 1',
    estado: 'finalizado'
  },
  {
    ...
    deporte: 'BÁSQUET',
    enfrentamiento: 'BLANCO VS VERDE',
    categoria: 'Juvenil B (9º, 10º y 11º)',
    arbitro: 'ENRIQUE ALCAZAR 9C',
    apoyo: 'Saira Ramirez, Mario Nuñez, Karol Caballero, Diana Liviapoma',
    lugar: 'Campo 1',
    estado: 'finalizado'
  },

  {
    ...
    semana: 1,
    fecha: '2026-09-15',
    dia: 'Martes 15/09/2026',
    hora: '09:35 - 09:55 am',
    deporte: 'CONEBALL',
    enfrentamiento: 'ANARANJADO VS AZUL',
    categoria: 'Infantil (3º y 4º)',
    arbitro: 'DAVID',
    apoyo: 'Melissa Gurrionero, Liz Natividad, Valeria Valverde, David Sajami',
    lugar: 'Campo 1',
    estado: 'proximo'
  },
  {
    ...
    categoria: 'Junior (5º y 6º)',
    arbitro: 'DAVID',
    apoyo: 'Gloria Huaman, Pamela Coronado, Karl Sopla, Mariaelena Castillo',
    lugar: 'Campo 1',
    estado: 'proximo'
  },
  {
    ...
    categoria: 'Juvenil A (7º y 8º)',
    arbitro: 'ENRIQUE ALCAZAR',
    apoyo: 'Mario Nuñez, Karol Caballero, David Sajami',
    lugar: 'Campo 1',
    estado: 'proximo'
  },

  {
    ...
    semana: 1,
    fecha: '2026-09-16',
    dia: 'Miércoles 16/09/2026',
    hora: '09:35 - 09:55 am',
    deporte: 'BALONMANO',
    enfrentamiento: 'BLANCO VS VERDE',
    categoria: 'Infantil (3º y 4º)',
    arbitro: 'MARIO NUÑEZ',
    apoyo: 'Mayra Alarcon, Karla Armas, Jorge Romero, Valeria Valverde',
    lugar: 'Campo 1',
    estado: 'proximo'
  },
  {
    ...
    categoria: 'Junior (5º y 6º)',
    arbitro: 'MARIO NUÑEZ',
    apoyo: 'David Sajami, Leakey Gambini, Dayanara Quirica',
    lugar: 'Campo 1',
    estado: 'proximo'
  },

  {
    ...
    semana: 1,
    fecha: '2026-09-17',
    dia: 'Jueves 17/09/2026',
    hora: '09:35 - 09:55 am',
    deporte: 'BALONMANO',
    enfrentamiento: 'ANARANJADO VS AZUL',
    categoria: 'Infantil (3º y 4º)',
    arbitro: 'DAVID',
    apoyo: 'Liz Natividad, David Sajami, Karla Armas, Valeria Valverde',
    lugar: 'Campo 1',
    estado: 'proximo'
  },
  {
    ...
    semana: 1,
    fecha: '2026-09-18',
    dia: 'Viernes 18/09/2026',
    hora: '09:35 - 09:55 am',
    deporte: 'VÓLEY',
    enfrentamiento: 'ANARANJADO VS AZUL',
    categoria: 'Infantil (3º y 4º)',
    arbitro: 'MARIO NUÑEZ',
    apoyo: 'Leakey Gambini, Karl Sopla, Marisol Reynaga, Valeria Valverde',
    lugar: 'Campo 1',
    estado: 'proximo'
  },
  ...
  // --- SEMANA 2 (21/09 al 28/09) ---
  {
    ...
    semana: 2,
    fecha: '2026-09-21',
    dia: 'Lunes 21/09/2026',
    hora: '09:35 - 09:55 am',
    deporte: 'VÓLEY Y PASABOLA',
    enfrentamiento: 'BLANCO VS VERDE',
    categoria: 'Infantil (3º y 4º)',
    arbitro: 'DAVID',
    apoyo: 'Melissa Gurrionero, Gloria Huaman, Nicol Aguilar, Leakey Gambini',
    lugar: 'Campo 1',
    estado: 'proximo'
  },
  {
    ...
    semana: 2,
    fecha: '2026-09-22',
    dia: 'Martes 22/09/2026',
    hora: '09:35 - 09:55 am',
    deporte: 'FUTSAL',
    enfrentamiento: 'VERDE VS AZUL',
    categoria: 'Infantil (3º y 4º)',
    arbitro: 'DAVID',
    apoyo: 'Melissa Gurrionero, Liz Natividad, Valeria Valverde',
    lugar: 'Campo 1',
    estado: 'proximo'
  },
  {
    ...
    semana: 2,
    fecha: '2026-09-23',
    dia: 'Miércoles 23/09/2026',
    hora: '09:35 - 09:55 am',
    deporte: 'FUTSAL',
    enfrentamiento: 'BLANCO VS ANARANJADO',
    categoria: 'Infantil (3º y 4º)',
    arbitro: 'MARIO NUÑEZ',
    apoyo: 'Mayra Alarcon, Karla Armas, Jorge Romero',
    lugar: 'Campo 1',
    estado: 'proximo'
  },
  {
    ...
    semana: 2,
    fecha: '2026-09-24',
    dia: 'Jueves 24/09/2026',
    hora: '09:35 - 09:55 am',
    deporte: 'CONEBALL - BÁSQUET',
    enfrentamiento: 'BLANCO VS VERDE',
    categoria: 'Infantil (3º y 4º)',
    arbitro: 'DAVID',
    apoyo: 'Liz Natividad, Karla Armas, Valeria Valverde',
    lugar: 'Campo 1',
    estado: 'en-vivo'
  },
  {
    ...
    semana: 2,
    fecha: '2026-09-28',
    dia: 'Lunes 28/09/2026',
    hora: '09:35 - 09:55 am',
    deporte: '3ER Y 4TO PUESTO BALONMANO',
    enfrentamiento: 'BLANCO VS VERDE',
    categoria: 'Infantil (3º y 4º)',
    arbitro: 'DAVID',
    apoyo: 'Melissa Gurrionero, Gloria Huaman, Nicol Aguilar',
    lugar: 'Campo 1',
    estado: 'proximo'
  }
];
